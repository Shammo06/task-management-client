...
const LogIn = () => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className=" w-80 md:w-96 bg-black bg-opacity-15 mx-auto card-body border-2 bg- border-green-500">
            ...
            <p className='text-white bg-indigo-600'>Do not Have Account? <Link className="text-red-400 font-bold" to='/registration'>Go Register</Link></p> 
            </div>             
        </form>
        </div>
    );
